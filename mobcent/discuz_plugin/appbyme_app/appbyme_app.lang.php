...
$scriptlang[APPBYME_DZ_PLUGIN_ID] = array(
    ...
    'mobcent_jump_tips'=>'
        <li>填写微站地址的时候，请注意需要带http://，不需要带/m，否则会引起跳转失败</li>
        <li>若没有写明，均为Discuz跳转微站</li>
    ',
    'mobcent_jump_name'=>'微站跳转管理',
    'mobcent_jump_wzurl_name'=>'微站地址',
    'mobcent_jump_wzurl_tips'=>'需要带http://，不需要带/m，否则会引起跳转失败',
    'mobcent_jump_inapp_name'=>'在客户端中是否跳转',
    'mobcent_jump_inapp_tips'=>'选择否之后，客户端内不跳转微站',
    'mobcent_jump_article_name'=>'文章跳转是否跳转微站',
    'mobcent_jump_article_tips'=>'打开之后，访问Discuz手机文章详情，会跳转对应的微站帖子详情',
    'mobcent_jump_forum_name'=>'帖子列表是否跳转微站',
    'mobcent_jump_forum_tips'=>'打开之后，访问Discuz手机帖子，会跳转对应的帖子列表页',
    'mobcent_jump_thread_name'=>'帖子跳转',
    'mobcent_jump_thread_-1'=>'都不跳转',
    'mobcent_jump_thread_0'=>'普通帖',
    'mobcent_jump_thread_1'=>'投票帖',
    'mobcent_jump_thread_2'=>'商品贴',
    'mobcent_jump_thread_3'=>'悬赏贴',
    'mobcent_jump_thread_4'=>'活动贴',
    'mobcent_jump_thread_5'=>'辩论帖',
    'mobcent_jump_thread_127'=>'插件帖',
    'mobcent_jump_thread_tips'=>"按住Ctrl多选<br /> 若选择了都不跳转，那么所有帖子均不跳转。哪些帖子允许跳转微站",
    'mobcent_jump_user_name'=>'用户中心跳转微站',
    'mobcent_jump_user_tips'=>'选择是之后，访问Discuz手机用户中心，会跳转对应的微站用户中心',
    'mobcent_jump_plugin_name'=>'插件跳转微站',
    'mobcent_jump_plugin_tips'=>'选择是之后，访问Discuz插件，会跳转微站首页',
    'mobcent_jump_all_name'=>'全局跳转',
    'mobcent_jump_all_tips'=>'开启之后，非以上页面将会跳转微站首页',
    'mobcent_jump_wzjump_name'=>'pc访问微站帖子详情是否跳转pc',
    'mobcent_jump_wzjump_tips'=>'开启之后，用pc访问微站详情时，会直接跳转pc详情',
    'mobcent_jump_member_name'=>'登录跳转',
    'mobcent_jump_member_tips'=>'开启之后，登录和注册都会跳转微站',
