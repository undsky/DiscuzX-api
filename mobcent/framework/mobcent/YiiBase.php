...
class YiiBase
{
	...
	private static $_coreClasses=array(
        ...
        'SentinelClient'=>'/caching/RedisSentinel/SentinelClient.php',
        'ConnectionFailureExecption'=>'/caching/RedisSentinel/ConnectionFailureExecption.php',
        'ConnectionTcpExecption'=>'/caching/RedisSentinel/ConnectionTcpExecption.php',
        'Sentinel'=>'/caching/RedisSentinel/Sentinel.php',
        'CYacCache'=>'/caching/CYacCache.php',
