        ...
        if(empty($title)) {
            ...
            if($fav) {
                ...
                switch($idType) {
                    ...
                    case 'aid':C::t('portal_article_count')->increase($id, array('favtimes' => 1));break;
                    default:
                    break;
                }
                    $params['noError'] = 1;
        ...
        if($setType == 'all') {
            ...
            if(empty($thevalue) || $thevalue['uid'] != $_G['uid']) {
                ...
                case 'fid':
                    ...
                    break;
                case 'aid':
                    //DB::query('UPDATE '.DB::table('portal_article_count').' SET favtimes = favtimes - 1 WHERE aid = '.$thevalue['id']);
                    C::t('portal_article_count')->increase(array($thevalue['id']), array('favtimes' => '-1'));
                    break;
                default:
                    break;
                }
