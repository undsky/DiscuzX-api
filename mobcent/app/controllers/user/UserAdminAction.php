...
class UserAdminAction extends MobcentAction {
    ...
    private function _userBlackSetting($res, $blackUid) {
        ...
        $res['errcode'] = Yii::t('mobcent','mobcent_success_home_black_add');
        $res['head']['errInfo'] = Yii::t('mobcent','mobcent_success_home_black_add');
        return $res;
    }
    ...
    private function _userDelBlackSetting($res, $delBlackUid) {
        ...
        $params['noError'] = 1;
        $res = $this->makeErrorInfo($res, 'do_success', $params);
        $res['errcode'] = Yii::t('mobcent','mobcent_success_home_black_del');
        $res['head']['errInfo'] = Yii::t('mobcent','mobcent_success_home_black_del');
        return $res;
    }
