...
class UploadUtils
{
    ...
    public static function getUploadVideoBaseUrlPath()
    {
        return MOBCENT_UPLOAD_URL_PATH . '/video';
    }
    ...
    public static function getUploadVideoBasePath($suffixPath = '')
    {
        $tempPath = $suffixPath != '' ? '/' . $suffixPath : '';
        $basePath = sprintf('%s%s', MOBCENT_UPLOAD_PATH . '/video', $tempPath);
        return self::makeBasePath($basePath);
    }
