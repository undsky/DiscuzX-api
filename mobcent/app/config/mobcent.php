...
return array(
    ...
    'cache' => array(
        ...
        'imageInfo'=> array( //图片信息缓存，默认关闭
            'enable'=>0, //是否开启, 1为开启,0为关闭
            'expire'=>DAY_SECONDS*30,// 缓存时间，单位秒
        ),
    ),
    //CDN自动处理缩略图相关配置，修改成功之后，需要重新生成缓存
    'thumb'=>array(
        'enable'=>0, //是否开启CDN自动处理缩略图
        'domain'=>'', //需要匹配的域名
        'str'=>'?imageView2/2/w/{width}', //图片地址增加的内容 {width}为缩略图宽度 默认是七牛的格式
    ),
    'db' => array(
